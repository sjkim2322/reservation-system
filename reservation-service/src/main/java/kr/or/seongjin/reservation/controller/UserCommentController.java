...
public class UserCommentController {
	 ...
	 @GetMapping("/{id}")
	 public List<UserComment> getListCommentByProductId(@PathVariable Integer id , HttpServletResponse  response){
		 ...
		 response.addIntHeader("totalCount", userCommentService.getTotalCount(id));
	        return userCommentService.listUserCommentByProductId(id);
	 }
