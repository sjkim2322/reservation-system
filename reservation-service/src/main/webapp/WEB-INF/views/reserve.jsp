               ...
               <script id="product-reservDetail-template" type="text/forHandlebars">
                        ...
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170217_264/1487312141947lTddT_JPEG/%B3%D7%C0%CC%B9%F6.jpg?type=ff1242_816"> <span class="img_bg"></span>
                                <div class="preview_txt">
									...
									{{#if prices}} 
									<em class="preview_txt_dsc">₩ {{prices.[0].price}} ~ </em>
									{{/if}}
									{{#if display_start}}
									<em class="preview_txt_dsc">{{display_start}}~{{display_end}}, 잔여티켓 송골 매</em>
									{{/if}}
								 </div>
                            </li>
                        </ul>
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        ...
                        <p class="dsc">
						{{#if place_name}}
                                                       장소 : {{place_lot}} {{place-street}} {{place_name}}<br> 
						{{/if}}
						{{#if display_start}}
						기간 : {{display_start}}~{{display_end}}
						{{/if}}
                        </p>
						{{#if observation_time}}
                        ...
                        <p class="dsc">
                        {{#each prices}}
							{{priceHelper price_type}} {{price}}<br> 
                        {{/each}}
                        </p>
						{{/if}}
                    </div>
                ...
                <div class="section_booking_ticket">
                    <div class="ticket_body">
                        ...
                        <div class="qty">
                            ...
                            <div class="qty_info_icon"> <strong class="product_amount"> <span>{{priceHelper price_type}}</span> </strong> <strong class="product_price"> <span class="price">{{price}}</span> <span class="price_type">원</span> </strong> <em class="product_dsc"><span>{{discountHelper discount_rate price}}</span> 원 ({{discountHelper discount_rate}}% 할인가)</em> </div>
                        </div>
                        {{/each}}
                    </div>
                </div>
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected">{{display_start}}~{{display_end}}, 총<span>0</span>매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
