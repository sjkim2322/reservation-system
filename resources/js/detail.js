require.config({
    ...
    paths: {
        ...
        Flicking : 'Flicking',
        NaverMap : 'https://openapi.map.naver.com/openapi/v3/maps.js?clientId=8bYQ0yuErj7kN82FyW8m&submodules=geocoder',
        Popup : 'Popup'
    }
});

require(['jquery', 'HandlebarsModule','Flicking','NaverMap','Popup'],
function($,HandlebarsModule,Flicking,naver,Popup){
